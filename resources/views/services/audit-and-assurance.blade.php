...
<div style="position: relative; margin-top: -1.5rem; min-height: 100vh; display: flex;">
        ...
        <div style="margin-top: 80px;">
            ...
            <div style="border-left: 6px solid #326D78; padding-left: 2rem; margin-bottom: 3rem;">
                ...
                <h1 style="font-size: 3.5rem; font-weight: 700; color: #333; margin: 0.5rem 0; line-height: 1.1;">
                    Audit and<br><span style="font-weight: 700;">Assurance</span>
                </h1>
            </div>
            ...
            <div style="max-width: 500px;">
                ...
                <div style="margin-bottom: 3rem; padding: 2rem; background: #f8f9fa; border-radius: 0 25px 25px 0; border-left: 4px solid #326D78;">
                    <h3 style="color: #326D78; font-weight: 600; margin-bottom: 1rem; font-size: 1.5rem;">Beyond Basic Compliance</h3>
                ...
                <div style="margin-bottom: 3rem;">
                    <div style="display: flex; align-items: flex-start; margin-bottom: 2rem;">
                        ...
                        <p style="color: #666; line-height: 1.7; margin: 0; font-size: 1.2rem;">
                            <strong style="color: #333;">Client-Focused Approach:</strong> We understand the need to provide advice to help you develop your business and achieve your commercial objectives.
                        </p>
                    </div>
                    <div style="display: flex; align-items: flex-start; margin-bottom: 2rem;">
                        <div style="background: #326D78; width: 12px; height: 12px; border-radius: 50%; margin-top: 6px; margin-right: 1.5rem; flex-shrink: 0;"></div>
                        <p style="color: #666; line-height: 1.7; margin: 0; font-size: 1.2rem">
                            <strong style="color: #333;">Strong Relationships:</strong> The key to a valuable compliance service is the strength of the relationship between the client and service team.
                        </p>
                    </div>
                    <div style="display: flex; align-items: flex-start;">
                        <div style="background: #326D78; width: 12px; height: 12px; border-radius: 50%; margin-top: 6px; margin-right: 1.5rem; flex-shrink: 0;"></div>
                        <p style="color: #666; line-height: 1.7; margin: 0; font-size: 1.2rem">
                            <strong style="color: #333;">Expert Team:</strong> By involving the most experienced members of our team right from the start, we focus on your specific strategic needs.
                        </p>
                    </div>
                </div>
                ...
                <div style="background: #326D78; padding: 2rem; border-radius: 15px; color: white;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 1rem;">
                        <div style="display: flex; align-items: center;">
                            ...
                            <span>External audit of financial statements</span>
                        </div>
                        <div style="display: flex; align-items: center;">
                            <i class="fas fa-check-circle" style="margin-right: 1rem; color: rgba(255,255,255,0.8);"></i>
                            <span>Other assurance and attestation services</span>
                        </div>
                    </div>
                </div>
    ...
    <div style="flex: 1; background: linear-gradient(45deg, #326D78 0%, #326D78 30%, #4a8a96 70%, #5ba3b0 100%); position: relative; display: flex; align-items: center; justify-content: center; overflow: hidden;">
        ...
        <div style="text-align: center; color: white; position: relative; z-index: 2;">
            ...
            <div style="background: rgba(255,255,255,0.2); width: 140px; height: 140px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 2rem; backdrop-filter: blur(10px); border: 2px solid rgba(255,255,255,0.3);">
                <i class="fas fa-search-dollar" style="font-size: 4rem; color: white;"></i>
            </div>
            ...
            <div style="background: rgba(255,255,255,0.15); padding: 2rem; border-radius: 20px; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.2);">
                <h3 style="font-size: 2.5rem; font-weight: 700; margin-bottom: 0.5rem; color: white;">Professional</h3>
                <p style="margin-bottom: 2rem; opacity: 0.9; font-size: 1.1rem;">Audit & Assurance Services</p>

                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-top: 2rem;">
                    <div>
                        <h4 style="font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem; color: white;">10+</h4>
                        <small style="opacity: 0.8; font-size: 0.9rem;">Years Experience</small>
                    </div>
                    <div>
                        <h4 style="font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem; color: white;">100%</h4>
                        <small style="opacity: 0.8; font-size: 0.9rem;">Client Focused</small>
                    </div>
                    <div>
                        <h4 style="font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem; color: white;">24/7</h4>
                        <small style="opacity: 0.8; font-size: 0.9rem;">Support Available</small>
                    </div>
                    <div>
                        <h4 style="font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem; color: white;">Expert</h4>
                        <small style="opacity: 0.8; font-size: 0.9rem;">Team Members</small>
                    </div>
                </div>
            </div>
