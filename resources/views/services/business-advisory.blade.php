...
<div style="position: relative; margin-top: -1.5rem; min-height: 100vh; display: flex;">
        ...
        <div style="margin-top: 80px;">
            ...
            <div style="border-left: 6px solid #326D78; padding-left: 2rem; margin-bottom: 3rem;">
                ...
                <h1 style="font-size: 3.5rem; font-weight: 700; color: #333; margin: 0.5rem 0; line-height: 1.1;">
                    Business<br><span style="font-weight: 700;">Advisory</span>
                </h1>
            </div>
            ...
            <div style="max-width: 500px;">
                ...
                <div style="margin-bottom: 3rem; padding: 2rem; background: #f8f9fa; border-radius: 0 25px 25px 0; border-left: 4px solid #326D78;">
                    <h3 style="color: #326D78; font-weight: 600; margin-bottom: 1rem; font-size: 1.5rem;">Targeted Consulting Advice</h3>
                ...
                <div style="margin-bottom: 3rem;">
                    <div style="display: flex; align-items: flex-start; margin-bottom: 2rem;">
                        ...
                        <p style="color: #666; line-height: 1.7; margin: 0; font-size: 1.2rem;">
                            <strong style="color: #333;">Deep Understanding:</strong> By developing a real understanding of your business and the issues and challenges you face, our advisory teams use local and global knowledge to help you achieve your goals.
                        </p>
                    </div>
                    <div style="display: flex; align-items: flex-start; margin-bottom: 2rem;">
                        <div style="background: #326D78; width: 12px; height: 12px; border-radius: 50%; margin-top: 6px; margin-right: 1.5rem; flex-shrink: 0;"></div>
                        <p style="color: #666; line-height: 1.7; margin: 0; font-size: 1.2rem">
                            <strong style="color: #333;">Risk Mitigation & Success:</strong> Not only do we help you understand and plan to mitigate your vulnerabilities, we also help you to establish a clear pathway to success.
                        </p>
                    </div>
                    <div style="display: flex; align-items: flex-start;">
                        <div style="background: #326D78; width: 12px; height: 12px; border-radius: 50%; margin-top: 6px; margin-right: 1.5rem; flex-shrink: 0;"></div>
                        <p style="color: #666; line-height: 1.7; margin: 0; font-size: 1.2rem">
                            <strong style="color: #333;">Proven Track Record:</strong> We have experience working with a range of clients — from family-owned businesses to public companies and from entrepreneurial start-ups to established global entities.
                        </p>
                    </div>
                </div>
    ...
    <div style="flex: 1; background: linear-gradient(45deg, #28a745 0%, #28a745 30%, #20c997 70%, #17a2b8 100%); position: relative; display: flex; align-items: center; justify-content: center; overflow: hidden;">
        ...
        <div style="text-align: center; color: white; position: relative; z-index: 2;">
            ...
            <div style="background: rgba(255,255,255,0.2); width: 140px; height: 140px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 2rem; backdrop-filter: blur(10px); border: 2px solid rgba(255,255,255,0.3);">
                <i class="fas fa-lightbulb" style="font-size: 4rem; color: white;"></i>
            </div>
            ...
            <div style="background: rgba(255,255,255,0.15); padding: 2rem; border-radius: 20px; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.2);">
                ...
                <p style="margin-bottom: 2rem; opacity: 0.9; font-size: 1.1rem;">Business Advisory Services</p>

                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-top: 2rem;">
                    <div>
                        <h4 style="font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem; color: white;">Global</h4>
                        <small style="opacity: 0.8; font-size: 0.9rem;">Knowledge Base</small>
                    </div>
                    <div>
                        <h4 style="font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem; color: white;">All</h4>
                        <small style="opacity: 0.8; font-size: 0.9rem;">Business Sizes</small>
                    </div>
                    <div>
                        <h4 style="font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem; color: white;">Growth</h4>
                        <small style="opacity: 0.8; font-size: 0.9rem;">Focused Plans</small>
                    </div>
                    <div>
                        <h4 style="font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem; color: white;">Success</h4>
                        <small style="opacity: 0.8; font-size: 0.9rem;">Pathway Clear</small>
                    </div>
                </div>
            </div>
