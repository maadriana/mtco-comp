...
<div style="position: relative; margin-top: -1.5rem; min-height: 100vh; display: flex;">
        ...
        <div style="margin-top: 80px;">
            ...
            <div style="border-left: 6px solid #326D78; padding-left: 2rem; margin-bottom: 3rem;">
                ...
                <h1 style="font-size: 3.5rem; font-weight: 700; color: #333; margin: 0.5rem 0; line-height: 1.1;">
                    Forensic and<br><span style="font-weight: 700;">Litigation Support</span>
                </h1>
            </div>
            ...
            <div style="max-width: 500px;">
                ...
                <div style="margin-bottom: 3rem; padding: 2rem; background: #f8f9fa; border-radius: 0 25px 25px 0; border-left: 4px solid #326D78;">
                    <h3 style="color: #326D78; font-weight: 600; margin-bottom: 1rem; font-size: 1.5rem;">Protecting Your Interests</h3>
                ...
                <div style="margin-bottom: 3rem;">
                    <div style="display: flex; align-items: flex-start; margin-bottom: 2rem;">
                        ...
                        <p style="color: #666; line-height: 1.7; margin: 0; font-size: 1.2rem;">
                            <strong style="color: #333;">Comprehensive Investigation:</strong> We provide a range of investigation services for contractual and commercial disputes, forensic investigations, valuations, and individual and family disputes.
                        </p>
                    </div>
                    <div style="display: flex; align-items: flex-start; margin-bottom: 2rem;">
                        <div style="background: #326D78; width: 12px; height: 12px; border-radius: 50%; margin-top: 6px; margin-right: 1.5rem; flex-shrink: 0;"></div>
                        <p style="color: #666; line-height: 1.7; margin: 0; font-size: 1.2rem">
                            <strong style="color: #333;">Expert Skills:</strong> We offer experts with skills in a variety of areas and experience in all types of dispute, globally.
                        </p>
                    </div>
                    <div style="display: flex; align-items: flex-start;">
                        <div style="background: #326D78; width: 12px; height: 12px; border-radius: 50%; margin-top: 6px; margin-right: 1.5rem; flex-shrink: 0;"></div>
                        <p style="color: #666; line-height: 1.7; margin: 0; font-size: 1.2rem">
                            <strong style="color: #333;">Litigation Ready:</strong> Our team provides effective support through all stages of legal proceedings, from investigation to expert testimony.
                        </p>
                    </div>
                </div>
                ...
                <div style="background: #326D78; padding: 2rem; border-radius: 15px; color: white;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 1rem;">
                        <div style="display: flex; align-items: flex-start;">
                            <i class="fas fa-check-circle" style="margin-right: 1rem; color: rgba(255,255,255,0.8); margin-top: 4px; flex-shrink: 0;"></i>
    ...
    <div style="flex: 1; background: linear-gradient(45deg, #294348 0%, #326D78 30%, #142b2f 70%, #8cb1b7 100%); position: relative; display: flex; align-items: center; justify-content: center; overflow: hidden;">
        ...
        <div style="text-align: center; color: white; position: relative; z-index: 2;">
            ...
            <div style="background: rgba(255,255,255,0.15); padding: 2rem; border-radius: 20px; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.2);">
                ...
                <p style="margin-bottom: 2rem; opacity: 0.9; font-size: 1.1rem;">Forensic & Litigation Services</p>

                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-top: 2rem;">
                    <div>
                        <h4 style="font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem; color: white;">Expert</h4>
                        <small style="opacity: 0.8; font-size: 0.9rem;">Witness Services</small>
                    </div>
                    <div>
                        <h4 style="font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem; color: white;">Global</h4>
                        <small style="opacity: 0.8; font-size: 0.9rem;">Dispute Experience</small>
                    </div>
                    <div>
                        <h4 style="font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem; color: white;">Forensic</h4>
                        <small style="opacity: 0.8; font-size: 0.9rem;">Investigation</small>
                    </div>
                    <div>
                        <h4 style="font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem; color: white;">Litigation</h4>
                        <small style="opacity: 0.8; font-size: 0.9rem;">Support Ready</small>
                    </div>
                </div>
            </div>
