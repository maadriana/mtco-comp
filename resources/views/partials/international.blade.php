        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-8" style="opacity: 0; animation: fadeInUp 1s ease-out 0.5s forwards;">
                <h1 style="font-size: 3.5rem; font-weight: 700; color: #2a2a2a; margin-bottom: 1.2rem; line-height: 1.1;">
                    AGN <span style="color: #326D78;">International</span>
                </h1>
                ...
                <div style="display: flex; gap: 2.5rem; flex-wrap: wrap;">
                    <div style="text-align: left;">
                        <div style="font-size: 2.2rem; font-weight: 700; color: #326D78; margin-bottom: 0.3rem;">200+</div>
                        <div style="font-size: 0.95rem; color: #6c757d; font-weight: 500;">Member Firms</div>
                    </div>
                    <div style="text-align: left;">
                        <div style="font-size: 2.2rem; font-weight: 700; color: #5ba3b0; margin-bottom: 0.3rem;">80+</div>
                        <div style="font-size: 0.95rem; color: #6c757d; font-weight: 500;">Countries</div>
                    </div>
                    <div style="text-align: left;">
                        <div style="font-size: 2.2rem; font-weight: 700; color: #4a8a96; margin-bottom: 0.3rem;">Global</div>
                        <div style="font-size: 0.95rem; color: #6c757d; font-weight: 500;">Reach</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-9">
                    ...
                    <div class="row text-center">
                        <div class="col-md-4">
                            <div style="background: white; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.06); margin-bottom: 1rem;">
                                <div style="font-size: 2.5rem; font-weight: 700; color: #326D78; margin-bottom: 0.5rem;">200+</div>
                                <div style="font-size: 1rem; color: #6c757d; font-weight: 500;">Member Firms</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div style="background: white; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.06); margin-bottom: 1rem;">
                                <div style="font-size: 2.5rem; font-weight: 700; color: #5ba3b0; margin-bottom: 0.5rem;">80+</div>
                                <div style="font-size: 1rem; color: #6c757d; font-weight: 500;">Countries</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div style="background: white; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.06); margin-bottom: 1rem;">
                                <div style="font-size: 2.5rem; font-weight: 700; color: #4a8a96; margin-bottom: 0.5rem;">Global</div>
                                <div style="font-size: 1rem; color: #6c757d; font-weight: 500;">Network</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-bottom: 5rem; opacity: 0; animation: fadeInUp 1s ease-out 0.7s forwards;">
                    ...
                    <p style="font-size: 1.15rem; color: #495057; line-height: 1.8; margin-bottom: 1.5rem;">
                        Our affiliation with AGN enhances our ability to support clients with cross-border needs, access international technical resources, and benchmark best practices in accounting, audit, and tax. Whether you're a Philippine-based company expanding globally, or a multinational doing business in the Philippines, we leverage our AGN network to bring solutions that are both locally relevant and internationally informed.
                    </p>
                    <p style="font-size: 1.15rem; color: #495057; line-height: 1.8; margin: 0;">
                        As an AGN member firm, we remain fully independent and responsible for the services we provide to our clients. Our membership simply gives us access to a trusted network of professionals across the globe who share our commitment to service excellence, ethical standards, and technical competence.
                    </p>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-4">
                            <div style="background: white; padding: 2rem; border-radius: 12px; box-shadow: 0 6px 20px rgba(0,0,0,0.08); height: 100%; border-top: 4px solid #326D78; transition: all 0.3s ease;">
                                ...
                                <p style="color: #6c757d; line-height: 1.7; margin: 0;">
                                    Direct access to local expertise in major markets around the world through a trusted global community.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div style="background: white; padding: 2rem; border-radius: 12px; box-shadow: 0 6px 20px rgba(0,0,0,0.08); height: 100%; border-top: 4px solid #5ba3b0; transition: all 0.3s ease;">
                                ...
                                <p style="color: #6c757d; line-height: 1.7; margin: 0;">
                                    Seamless coordination with fellow AGN members for cross-border transactions, market entry, or overseas expansion.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div style="background: white; padding: 2rem; border-radius: 12px; box-shadow: 0 6px 20px rgba(0,0,0,0.08); height: 100%; border-top: 4px solid #4a8a96; transition: all 0.3s ease;">
                                ...
                                <h4 style="font-size: 1.25rem; font-weight: 600; color: #4a8a96; margin-bottom: 1rem;">
                                    Shared standards, global best practices
                                </h4>
                                <p style="color: #6c757d; line-height: 1.7; margin: 0;">
                                    Our AGN membership ensures access to global technical updates, benchmarking tools, and regulatory resources.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div style="margin-bottom: 5rem; opacity: 0; animation: fadeInUp 1s ease-out 0.9s forwards;">
                    ...
                    <p style="font-size: 1.15rem; color: #495057; line-height: 1.8; margin-bottom: 1.5rem;">
                        AGN International Ltd is a not-for-profit worldwide membership association of separate and independent accounting and advisory businesses.
                    </p>
                    <p style="font-size: 1.15rem; color: #495057; line-height: 1.8; margin: 0;">
                        To learn more about AGN and its member firms, please visit the AGN International website at
                        <a href="https://agn.org/" target="_blank" style="color: #326D78; text-decoration: none; font-weight: 600; border-bottom: 2px solid #326D78; transition: all 0.3s ease;">https://agn.org/</a>.
                    </p>
                </div>
                ...
                <div style="text-align: center; padding: 3rem; background: linear-gradient(135deg, #f8fafb 0%, #e8f4f8 100%); border-radius: 15px; box-shadow: 0 6px 20px rgba(0,0,0,0.06); opacity: 0; animation: fadeInUp 1s ease-out 1.3s forwards;">
                    <h3 style="font-size: 1.5rem; font-weight: 600; color: #2a2a2a; margin-bottom: 1rem;">
                        Ready to leverage our global network?
                    </h3>
                    <p style="font-size: 1.1rem; color: #6c757d; margin-bottom: 2rem;">
                        Connect with our team to learn how AGN International can support your business growth.
                    </p>
