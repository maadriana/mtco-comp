...
<section id="accounting-services-associate" class="py-5" data-aos="fade-up">
  <div class="container">
  ...
  <p style="font-size: 1.15rem; color: #444;"><strong>Job Type:</strong> Permanent</p>
    ...
    <div style="max-width: 900px; margin: 0 auto; font-size: 1.15rem; line-height: 1.8; color: #444444; text-align: justify;">
      ...
      <ul style="padding-left: 1.2rem; margin-top: 0.5rem;">
        ...
        <li>Coordinate with all third party application provider and share services</li>
        ...
        <li>Maintain portfolio activity, update entries in general ledger and evaluate it on regular basis to ensure accuracy in rate</li>
        <li>Prepare reports for respective accounts and clients</li>
        <li>Coordinate with internal auditors and answered all related queries and prepare associate reports on same</li>
        <li>Monitor all accounting deliverables, process all vouchers and ensure work according to deadline</li>
        ...
        <li>Forecast budget requirements, update journal entries and prepare reports on same</li>
      </ul>
