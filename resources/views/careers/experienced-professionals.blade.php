...
<div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
    <div class="feature-card" style="background: white; padding: 2.5rem; border-radius: 20px; height: 100%; box-shadow: 0 10px 30px rgba(0,0,0,0.1); border-left: 5px solid #326D78;">
        <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #44c7de, #4a8a96); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-bottom: 1.5rem; box-shadow: 0 6px 20px rgba(0,0,0,0.15);">
            <i class="fas fa-handshake" style="font-size: 1.8rem; color: white;"></i>
        </div>
        <h4 style="color: #326D78; font-weight: 600; margin-bottom: 1rem;">{{ getContent('professionalism_title', 'Professionalism') }}</h4>
...
<div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
    <div class="feature-card" style="background: white; padding: 2.5rem; border-radius: 20px; height: 100%; box-shadow: 0 10px 30px rgba(0,0,0,0.1); border-left: 5px solid #326D78;">
        ...
        <h4 style="color: #326D78; font-weight: 600; margin-bottom: 1rem;">{{ getContent('career_growth_title', 'Career Growth') }}</h4>
        <p style="color: #666; line-height: 1.7; margin: 0;">
            {{ getContent('career_growth_description', 'We invest in your success. From technical training and mentoring to leadership development and exposure to complex client engagements, MTC offers a platform where you can thrive and advance.') }}
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="500">
                    <div style="background: white; padding: 3rem 2rem; border-radius: 20px; box-shadow: 0 15px 40px rgba(0,0,0,0.1); border: 2px solid #326D78;">
                        ...
                        <h3 style="color: #333; font-weight: 700; margin-bottom: 1rem;">{{ getContent('experienced_cta_title', 'Ready to Make the Change?') }}</h3>
                        <p style="color: #666; margin-bottom: 2rem; font-size: 1.1rem;">
                            {{ getContent('experienced_cta_description', 'Join our team of experienced professionals and take your career to the next level.') }}
                        </p>
                        <div class="d-flex flex-wrap gap-3 justify-content-center">
                            <a href="#" class="btn btn-lg" style="background: #326D78; color: white; border: none; border-radius: 25px; padding: 0.8rem 2rem; font-weight: 600; transition: all 0.3s ease;">
                                <i class="fas fa-paper-plane me-2"></i>{{ getContent('experienced_cta_resume_text', 'Send Your Resume') }}
                            </a>
                            <a href="{{ route('careers.vacancies') }}" class="btn btn-outline-success btn-lg" style="border-radius: 25px; padding: 0.8rem 2rem; font-weight: 600; transition: all 0.3s ease;">
                                <i class="fas fa-briefcase me-2"></i>{{ getContent('experienced_cta_positions_text', 'View Open Positions') }}
                            </a>
                        </div>
                    </div>
                </div>
