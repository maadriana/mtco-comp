        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div style="margin-bottom: 3rem;" data-aos="fade-up">
                    ...
                    @else
                        <img src="{{ asset('assets/img/services.jpg') }}" alt="SEC Financial Reporting Standards" style="width: 100%; height: 350px; object-fit: cover; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                    @endif
                </div>
                ...
                <div style="border-top: 1px solid #e9ecef; padding-top: 2rem; margin-top: 3rem;" data-aos="fade-up" data-aos-delay="600">
                    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
                        ...
                        <div style="display: flex; gap: 0.75rem;">
                            <a href="#" style="width: 45px; height: 45px; background: #5ba3b0; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; text-decoration: none; transition: all 0.3s ease;">
